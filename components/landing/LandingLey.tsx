...
const articulos = [
  {
    ...
    desc: "Cálculo automático según prorrateo de derechos",
    contenido: {
      resumen: "Regula la obligación de todos los copropietarios de contribuir a los gastos comunes, proporcionalmente al avalúo fiscal de su unidad o según lo establezca el reglamento de copropiedad.",
      puntos: [
        "Todo copropietario debe pagar gastos comunes ordinarios y extraordinarios.",
        "El prorrateo se calcula según el avalúo fiscal de cada unidad o según el reglamento.",
        "El no pago genera intereses y puede derivar en acciones de cobranza.",
        "La administración debe emitir liquidaciones mensuales detalladas.",
        "Los gastos comunes incluyen: mantención, servicios, seguros y fondo de reserva.",
      ],
      aplicacion: "CondoSaaS genera automáticamente las liquidaciones mensuales aplicando el prorrateo correcto según el avalúo de cada unidad, con desglose completo por ítem de gasto.",
    },
  },
  {
    num: "Arts. 17–19",
    title: "Asambleas de copropietarios",
    desc: "Convocatoria, quórum y actas digitales",
    contenido: {
      resumen: "Establece las normas para la realización de asambleas ordinarias y extraordinarias, incluyendo convocatoria, quórum mínimo, materias a tratar y validez de los acuerdos.",
      puntos: [
        "Asamblea ordinaria: al menos una vez al año dentro de los 3 primeros meses.",
        "Asamblea extraordinaria: cuando lo exijan las circunstancias o lo pida el 10% de los copropietarios.",
        "Convocatoria con al menos 5 días de anticipación por escrito.",
        "Primera citación: mayoría absoluta de los derechos. Segunda: los presentes.",
        "Los acuerdos deben constar en acta firmada y estar disponibles para todos.",
      ],
      aplicacion: "CondoSaaS envía convocatorias electrónicas certificadas, controla el quórum en tiempo real, registra votaciones y genera actas digitales con firma electrónica simple.",
    },
  },
  {
    num: "Art. 24",
    title: "Rendición de cuentas",
    desc: "Balances periódicos con trazabilidad",
    contenido: {
      resumen: "Obliga al administrador a rendir cuenta documentada de su gestión a lo menos una vez al año en asamblea ordinaria, detallando ingresos, egresos y estado financiero de la comunidad.",
      puntos: [
      ...
      aplicacion: "CondoSaaS mantiene registro contable en tiempo real con respaldo de comprobantes digitales, generando reportes de rendición de cuentas listos para presentar en asamblea.",
    },
  },
  {
    num: "Art. 38",
    title: "Fondo de reserva",
    desc: "Mínimo 10% obligatorio, monitoreado",
    contenido: {
      resumen: "Establece la obligación de constituir y mantener un fondo de reserva equivalente a lo menos al 10% del presupuesto anual de gastos comunes, destinado a reparaciones mayores y obras urgentes.",
      puntos: [
      ...
      aplicacion: "CondoSaaS monitorea automáticamente el nivel del fondo de reserva, emite alertas cuando baja del 10% mínimo y registra cada movimiento con su justificación.",
    },
  },
  {
    num: "Art. 35",
    title: "Transparencia financiera",
    desc: "Información accesible a todos los copropietarios",
    contenido: {
      resumen: "Garantiza el derecho de todos los copropietarios a acceder a la información financiera y administrativa de la comunidad, incluyendo contratos, presupuestos y estados de cuenta.",
      puntos: [
      ...
      aplicacion: "CondoSaaS publica automáticamente balances, contratos y presupuestos en el portal de cada residente, garantizando transparencia permanente sin necesidad de solicitudes formales.",
    },
  },
  {
    num: "Art. 47",
    title: "Reglamento de copropiedad",
    desc: "Digitalización, versionado y firma electrónica",
    contenido: {
      resumen: "Regula el contenido mínimo obligatorio del reglamento de copropiedad, su modificación y la obligación de entregarlo a cada nuevo copropietario o arrendatario al momento de su ingreso.",
      puntos: [
      ...
      aplicacion: "CondoSaaS digitaliza el reglamento, mantiene historial de versiones, envía automáticamente a nuevos residentes y gestiona la firma electrónica simple de recepción conforme.",
    },
  },
];
          ...
          <div className="grid grid-cols-2 gap-3">
            {articulos.map((a) => (
              <button
                ...
                className="rounded-xl p-4 text-left transition-all hover:-translate-y-0.5 hover:shadow-lg"
                style={{
      ...
      {selected && (
        ...
        >
          <div
            ...
            style={{
              background: "linear-gradient(135deg,#0D1B2A 0%,#0D4A75 100%)",
          ...
          >
            ...
            <p className="mb-1 text-xs font-medium" style={{ color: "#5DCAA4" }}>
              {selected.num} · Ley 21.442
            </p>
            <h3 className="mb-4 font-serif text-2xl font-semibold text-white">
              {selected.title}
            </h3>

            <p className="mb-6 text-sm font-light leading-relaxed text-white/65">
              {selected.contenido.resumen}
            </p>
            ...
            >
              <p className="mb-1 text-xs font-medium" style={{ color: "#5DCAA4" }}>
                Cómo lo resuelve CondoSaaS
              </p>
              <p className="text-sm font-light leading-relaxed text-white/70">
                {selected.contenido.aplicacion}
              </p>
            </div>
          </div>
        </div>
